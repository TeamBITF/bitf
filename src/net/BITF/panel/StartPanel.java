...
//
	...
	public StartPanel(){
		...
		icon=new ImageIcon("Z:/0楠祭　鍵班/startgamen/Title.png");
		title= new JLabel(icon);
		title.setBounds(380,20,icon.getIconWidth(),icon.getIconHeight());

		ImageIcon btn1 = new ImageIcon("Z:/0楠祭　鍵班/startgamen/startbutton.png");
		JButton button1 = new JButton(btn1);
	    button1.setBounds(610, 540, 150,60 );
	    button1.setContentAreaFilled(false);
	    button1.setBorderPainted(false);

	    ImageIcon btn2 = new ImageIcon("Z:/0楠祭　鍵班/startgamen/rankingbutton.png");
