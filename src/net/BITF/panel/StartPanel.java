...
//
	...
	public StartPanel(){
		...
		icon = new ImageIcon(ResourceLoader.instance.getResource("data/Start/warp.gif"));
		fire = new JLabel(icon);
		fire.setBounds(0,0,icon.getIconWidth(),icon.getIconHeight());

		icon=new ImageIcon(ResourceLoader.instance.getResource("data/Start/car.png"));
		car= new JLabel(icon);
		car.setBounds(300,50,icon.getIconWidth(),icon.getIconHeight());

		icon=new ImageIcon(ResourceLoader.instance.getResource("data/Start/Title.png"));
		title= new JLabel(icon);
		title.setBounds(380,20,icon.getIconWidth(),icon.getIconHeight());

		ImageIcon btn1 = new ImageIcon(ResourceLoader.instance.getResource("data/Start/startbutton.png"));
		JButton button1 = new JButton(btn1);
	    button1.setBounds(610, 540, 150,60 );
	    button1.setContentAreaFilled(false);
	    button1.setBorderPainted(false);

	    ImageIcon btn2 = new ImageIcon(ResourceLoader.instance.getResource("data/Start/rankingbutton.png"));
